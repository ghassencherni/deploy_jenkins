...
do
    ...
    then
	    ...
	    echo "Create 'terraform_aws_eks' job..."
	    java -jar binaries/jenkins-cli.jar -auth admin:"${INIT_PASSWORD}" -s "${JENKINS_URL}" -webSocket create-job terraform_aws_eks < jenkins_files/terraform_aws_eks.xml
